...
class Theis:
    '''Implementation of solution of head change in aquifers due to
       injection based on the Theis solution: C.V. Theis (1935) The
       relation between the lowering of the piezometric surface and
       the rate and duration of discharge of a well using ground-water
       storage. Transactions of the American Geophysical Union, 2,
       519-524'''

    def __init__(self):
        pass

    def SetRequiredProperties(self, Q, S, T, InjectionEnd=-1, \
    ...
    def ListOrSingle(self, inValues):
        '''Determines if the inValues are a list or a single value.
           ...
           is True if the Values are a list and False if innValues is
           a single value.'''
        ...
        for tim in TimeList:
            for hed in HeadList:
                ...
                if res1 < hed:
                    ...
                    multip = [10, 50, 100, 500, 1000, 5000, 10000, 50000, 100000, \
